...
import AdminPedagogicalNotes from "./pages/admin/AdminPedagogicalNotes";
...
import SchoolMusicSchoolSelect from "./pages/SchoolMusicSchoolSelect";
import SchoolMusicRegisterSuccess from "./pages/SchoolMusicRegisterSuccess";

import StudentPaymentSuccess from "./pages/StudentPaymentSuccess";
        ...
        <AuthProvider>
          ...
          <AcademicYearProvider>
            <Routes>
              ...
              <Route path="/admin/cashflow" element={<AdminRoute><AdminCashflow /></AdminRoute>} />
              ...
              <Route path="/admin/message-templates" element={<AdminRoute><AdminMessageTemplates /></AdminRoute>} />
              <Route path="/admin/broadcast-archive" element={<AdminRoute><AdminBroadcastArchive /></AdminRoute>} />
...
<Route path="/admin/activity-calendar" element={<AdminRoute><AdminActivityCalendar /></AdminRoute>} />
              <Route path="/teacher/branches/:schoolId/schedule" element={<TeacherRoute><TeacherBranchSchedule /></TeacherRoute>} />
              <Route path="/admin/pedagogical-notes" element={<AdminRoute><AdminPedagogicalNotes /></AdminRoute>} />
              <Route path="/admin/operations-log" element={<AdminRoute><AdminOperationsLog /></AdminRoute>} />
