      ...
      <AlertDialog open={deleteOpen} onOpenChange={setDeleteOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              מומלץ מאוד להעביר את סטטוס התלמיד ל"הפסיק" במקום למחוק, כדי לשמור על ההיסטוריה המלאה (תשלומים, נוכחות, וכן היסטוריית השאלות של כלי נגינה — גם כלים שכבר הוחזרו).
              <br />
              מחיקה תסיר את התלמיד וכל הנתונים המקושרים אליו לצמיתות, כולל רישום ההשאלות שבוצעו בעבר, ולא ניתן יהיה לשחזר.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
