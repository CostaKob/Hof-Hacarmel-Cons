  ...
  const handleExportPdf = async () => {
    ...
    try {
      ...
      const buildHtml = (F: number) => {
        ...
        const cellStyle = `border:1px solid #aaa;padding:${Math.max(2, Math.round(F * 0.05))}px 3px;text-align:center;font-size:${F}px;white-space:nowrap;`;
        const headerStyle = `border:1px solid #aaa;padding:${Math.max(2, Math.round(F * 0.05))}px 4px;text-align:center;font-size:${hFont}px;font-weight:bold;background:#e8e8e8;white-space:nowrap;`;
