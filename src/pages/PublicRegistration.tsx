    ...
    <div className="min-h-screen bg-muted/30 py-6 px-4" dir="rtl">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">תנאי הרשמה ולימודים</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="bg-muted/50 rounded-lg p-4 text-sm text-muted-foreground leading-relaxed space-y-2">
                <p>• ההרשמה מהווה התחייבות לשנת לימודים מלאה.</p>
                <p>• התשלום עבור שיעורי הנגינה הוא חודשי וקבוע, ללא קשר למספר השיעורים בחודש.</p>
                <p>• ביטול הרשמה יתאפשר בהודעה מראש בכתב בלבד.</p>
                <p>• שיבוץ התלמידים למורים ולשלוחות ייעשה על פי שיקול דעת הנהלת האולפן.</p>
                <p>• אולפן המוסיקה שומר לעצמו את הזכות לעדכן תנאים אלה.</p>
              </div>
              <div className="flex items-start gap-3 pt-2">
                <Checkbox
                  ...
                  className="mt-0.5"
                />
                <Label htmlFor="approval" className="text-sm font-medium cursor-pointer leading-snug">
